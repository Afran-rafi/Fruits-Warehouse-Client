                ...
                <div className='container row mt-5'>
                    <div className="col-lg-4 ">
                        <div className="card color1">
                            <div>
                                <p className='text-center fw-bold'><i className="fa-solid fa-quote-left"></i> This is a best warehouse . All fruits are very fresh and juicy. <i className="fa-solid fa-quote-right"></i></p>
                            </div>
